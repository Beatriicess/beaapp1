...
class Usuario extends ModelClass {
  //El main recoge los datos y la clase los comprueba para decidir sobre ellos
  int idusuario = 0;
  String? nombre;
  String? nick;
  String? password;
  ...
  Usuario(
    ...
    this.password,
    this.monedas,
  ); //Este es el constructor con argumentos posicionales
  //CONTRUCTOR NOMBRADO
  ...
  static Future<bool> registro(Map<String, String> datos) async {
    //Cuando no necesita argumentos es por que no necesita datos del exterior, en este caso sí que son necesarios,
